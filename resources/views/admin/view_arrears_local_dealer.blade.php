...
<title>Pak Indus Ice Factory- View Arrears Local Dealer</title>
    ...
    <body>
        ...
        <div id="wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">View Arrears Local Dealer</h4>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">View Arrears Local Dealer</li>
                                    </ol>
            ...
            @endif   
                                            ...
                                            <h4 class="mt-0 header-title">View Arrears Local Dealer</h4>
                                            <p class="text-muted m-b-30">These are all the arrears of local dealers.</p>
                                              ...
                                              <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                  @foreach($local_dealer_arrears as $lda)   
                                                <tr>
                                                <?php
                                                $currentMonth = date('m');
$current_month_balance = \App\sales::select('total_price')->whereRaw('MONTH(date) = ?',[$currentMonth])->where('dealer_id','=',$lda->dealer_id)->sum('total_price');
?>

                                                    <td>{{$lda->dealer_name}}</td>
                                                    <td>
                                                        @if($lda->new_balance>0)
                                                        Rs {{$lda->new_balance}}
                                                        @else 0
                                                        @endif
                                                        </td>
                                         ...
                                         {{ csrf_field() }}
                                                          <div class="row">
                                                            <div class="col-sm-5">
                                                                <input type="hidden" value="{{$lda->dealer_id}}" name="dealer_id">
...
function printDiv() {
    ...
    newWin.document.write("<h3 align='center'>Arrears: Local Dealer");
