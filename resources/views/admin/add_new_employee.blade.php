...
<title>5 STAR Ice Factory
 Factory - Add New Employee</title>
...
@endif
 ...
 Factory</a></li>
            ...
            @endif   
                                            ...
                                            <h4 class="mt-0 header-title">Add New Employee</h4>
                                            <p class="text-muted m-b-30">Add the following details to add a new employee</p>
                                     <form action="{{route('employee.add')}}" method="POST">
                                         {{ csrf_field() }}
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Name</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" id="example-text-input" name="employee_name" placeholder="Name" required="">
                                                </div>
                                            </div>
    ...
    $(":input").inputmask();
                                            ...
                                            <div class="form-group row">
                                                <label for="example-email-input" class="col-sm-2 col-form-label">Post</label>
                                                <div class="col-sm-10">
                                                 <input type="text" class="form-control" name="employee_post" required="" placeholder="eg. Tank Man">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="form-group row">
                                                <label for="example-tel-input" class="col-sm-2 col-form-label">Salary</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="salary" id="example-tel-input" placeholder="Salary" required="">
                                                </div>
                                            </div>
