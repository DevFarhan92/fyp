...
<title>Pak Indus Ice Factory - Add New Cheque Received</title>
    ...
    <body>
        ...
        <div id="wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Add New Cheque Received</h4>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Pak Indus Ice Factory</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                                        <li class="breadcrumb-item active">Add New Cheque Received</li>
                                    </ol>
            ...
            @endif   
                                            ...
                                            <h4 class="mt-0 header-title">Add New Cheque Received</h4>
                                            <p class="text-muted m-b-30">Add the following details of the cheque received</p>
                                     <form action="{{route('cheque.received.add')}}" method="POST" enctype="multipart/form-data">
                                         {{ csrf_field() }}
                                           ...
                                           <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="date" id="example-text-input" name="clearing_date" placeholder="Date" required="">
                                                </div>
                                            </div>
                                          
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-sm-2 col-form-label">Cheque Number</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                <label for="example-email-input" class="col-sm-2 col-form-label">Cheque Amount</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="number" name="cheque_amount" placeholder="Cheque Amount" id="example-email-input" required="">
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group row">
                                                <label for="example-tel-input" class="col-sm-2 col-form-label">Cheque Attachment</label>
                                                <div class="col-sm-10">
                                                 <input type="file" class="form-control" name="cheque_attachment" accept="image/x-png,image/gif,image/jpeg">
                                                </div>
                                            </div>
