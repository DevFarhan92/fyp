...
<title>Pak Indus Ice Factory - Add New Cheque Given</title>
    ...
    <body>
        ...
        <div id="wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Add New Cheque Given</h4>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Pak Indus Ice Factory</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                                        <li class="breadcrumb-item active">Add New Cheque Given</li>
                                    </ol>
            ...
            @endif   
                                            ...
                                            <h4 class="mt-0 header-title">Add New Cheque Given</h4>
                                            <p class="text-muted m-b-30">Add the following details of the cheque given</p>
                                     <form action="{{route('cheque.given.add')}}" method="POST" enctype="multipart/form-data">
                                         {{ csrf_field() }}
