...
<title>Pak Indus Ice Factory- General Report Details</title>
...
@endif
    ...
    <body>
        ...
        <div id="wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">General Report Details</h4>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">General Report Details</li>
                                    </ol>
            ...
            @endif   
                                             <h4 class="mt-0 header-title" style="text-align: center; font-size: 25px">GENERAL REPORT</h4>
                                               <br>
                                           <!--  <h4 class="mt-0 header-title" style="text-align: center; font-size: 25px">Month: {{$month_name}}</h4>
                                            ...
                                            <p class="text-muted m-b-30" style="font-size: 16px; text-align: center;">These are all the sales made in between <b>{{$start_date1}} - {{$end_date1}}</b></p>
                                               <br>
                                               <h5 style="text-align: center;">Fisheries</h5>
                                               <br>
                                              <table class="table table-bordered mb-0">
                                                ...
                                                <tbody>
                                                    @foreach($overall_sales_fisheries as $osf)
                                                    <?php
                    
$total_blocks_fisheries_dealer = \App\sales::select('*')->where('dealer_id','=',$osf->dealer_id)->whereBetween('date', [Session::get('start_date'), Session::get('end_date')])->sum('no_of_blocks');
$total_sales_fisheries_dealer = \App\sales::select('*')->where('dealer_id','=',$osf->dealer_id)->whereBetween('date', [Session::get('start_date'), Session::get('end_date')])->sum('total_price');
?>
                                                <tr>
                                                    <td><b>{{$osf->dealer_name}}</b></td>
                                                    <td><b>{{$total_blocks_fisheries_dealer}}</b></td>
                                                    <td><b>{{$total_sales_fisheries_dealer}}</b></td>
                                                </tr>
                                               ...
                                               <br>
                                                ...
                                                <tbody>
                                                <tr>
                                                    <td><b>{{$total_blocks_fisheries}} </b></td>
                                                    <td><b>Rs {{$total_sale_fisheries}}</b></td>
                                            ...
                                            <h5 style="text-align: center;">Local</h5>
                                               <br>
                                              <table class="table table-bordered mb-0">
                                                <thead>
                                                ...
                                                <tbody>
                                                      @foreach($overall_sales_local as $osl)
                                                    <?php
                    
$total_blocks_local_dealer = \App\sales::select('*')->where('dealer_id','=',$osl->dealer_id)->whereBetween('date', [Session::get('start_date'), Session::get('end_date')])->sum('no_of_blocks');
$total_sales_local_dealer = \App\sales::select('*')->where('dealer_id','=',$osl->dealer_id)->whereBetween('date', [Session::get('start_date'), Session::get('end_date')])->sum('total_price');
?>
                                                <tr>
                                                     <td><b>{{$osl->dealer_name}}</b></td>
                                                    <td><b>{{$total_blocks_local_dealer}}</b></td>
                                                    <td><b>{{$total_sales_local_dealer}}</b></td>
                                                </tr>
                                                @endforeach
                                               ...
                                               <br>
                                                ...
                                                <tbody>
                                                <tr>
                                                    <td><b>{{$total_blocks_local}}</b></td>
                                                    <td><b>Rs {{$total_sale_local}} </b></td>
                                            ...
                                            <table class="table table-bordered mb-0">
                                                ...
                                                <tbody>
                                                 ...
                                                 <tr>
                                                    <td><b>Company Expense</b></td>
                                                    <td><b>Rs {{$total_expense_company}}</b></td>
                                                    
                                                </tr>
                                                 <tr>
                                                    <td><b>K-Electric Bill</b></td>
                                                    <td><b>Rs {{$total_expense_electricity}}</b></td>
                                                    
                                                </tr>
                                                 <tr>
                                                    <td><b>Local Expense</b></td>
                                                    <td><b>Rs {{$total_expense_local}}</b></td>
                                                    
                                                </tr>

                                                <tr>
                                                    <td><b>Salary Expense</b></td>
                                                    <td><b>Rs {{$total_expense_salary}}</b></td>
                                            ...
                                            <br><br>
                                             ...
                                             <table class="table table-bordered mb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b>Rs {{$total_sale-$total_expense_company-$total_expense_electricity-$total_expense_local-$total_expense_salary}}</b></td>
                ...
                <table>
                                                ...
                                                <tr>
                                                    <td colspan="3"><h3 style="text-align: center;">Fisheries</h3></td>
                                                    
                                                  
                                                </tr>
                                                 <tr>
                                                     <td style="width:200px;text-align: center;"><b>Name</b></td>
                                                     <td style="width:200px; text-align: center;"><b>Blocks</b></td>
...
?>
                                                <tr>
                                                    <td style="width:200px;text-align: center;">{{$osf->dealer_name}}</td>
                                                    <td style="width:200px;text-align: center;">{{$total_blocks_fisheries_dealer}}</td>
                                                    <td style="width:200px;text-align: center;">{{$total_sales_fisheries_dealer}}</td>
                                                </tr>
                                                 @endforeach
                                                <tr>
                                                    <td colspan="3"></td>
                                                ...
                                                <tr>
                                                    <td><b>TOTAL BLOCKS: {{$total_blocks_fisheries}} </b></td>
                                                    <td colspan="2"><b>TOTAL AMOUNT: Rs {{$total_sale_fisheries}} </b></td>
                                                </tr>
                                               ...
                                               <tr>
                                                ...
                                                <tr>
                                                    <td colspan="3"><h3 style="text-align: center;">Local Dealers</h3></td>
...
?>
                                                <tr>
                                                    <td style="width:200px;text-align: center;">{{$osl->dealer_name}}</td>
                                                    <td style="width:200px;text-align: center;">{{$total_blocks_local_dealer}}</td>
                                                    <td style="width:200px;text-align: center;">{{$total_sales_local_dealer}}</td>
                                                </tr>
                                                @endforeach
                                                <tr>
                                                    <td colspan="3"></td>
                                                ...
                                                <tr>
                                                    <td><b>TOTAL BLOCKS: {{$total_blocks_local}} </b></td>
                                                    <td colspan="2"><b>TOTAL AMOUNT: Rs {{$total_sale_local}} </b></td>
                                                </tr>
                                     <tr>
                                                    <td colspan="3"></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="3"><h3 style="text-align: center;">Total</h3></td>
                                                    
                                                  
                                                </tr>
                                                 <tr>
                                                    <td><b>TOTAL BLOCKS: {{$total_blocks}} </b></td>
                                                    <td colspan="2"><b>TOTAL AMOUNT: Rs {{$total_sale}} </b></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td><b>Company Expense</b></td>
                                                    <td colspan="2"><b>Rs {{$total_expense_company}}</b></td>
                                                    
                                                </tr>
                                                 <tr>
                                                    <td><b>K-Electric Bill</b></td>
                                                    <td colspan="2"><b>Rs {{$total_expense_electricity}}</b></td>
                                                    
                                                </tr>
                                                 <tr>
                                                    <td><b>Local Expense</b></td>
                                                    <td colspan="2"><b>Rs {{$total_expense_local}}</b></td>
                                                    
                                                </tr>
                                                  <tr>
                                                    <td><b>Salary Expense</b></td>
                                                    <td colspan="2"><b>Rs {{$total_expense_salary}}</b></td>
                                                ...
                                                <tr>
                                                    <td><b>Total Profit/Loss</b></td>
                                                    <td colspan="2"><b>Rs {{$total_sale-$total_expense_company-$total_expense_electricity-$total_expense_local-$total_expense_salary}}</b></td>
...
function printDiv() {
    ...
    newWin.document.write("<h3 align='center'>General Report</h3>");
    newWin.document.write("<h3 align='center'>These are all the sales made in between {{$start_date1}} - {{$end_date1}} </h4>");
