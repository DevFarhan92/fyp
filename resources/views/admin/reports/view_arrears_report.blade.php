...
<title>Pak Indus Ice Factory - Arrears History Report</title>
    ...
    <body>
        ...
        <div id="wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Arrears History Report</h4>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Pak Indus Ice Factory</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                                        <li class="breadcrumb-item active">Arrears History Report</li>
                                    </ol>
            ...
            @endif   
                                            ...
                                            <h4 class="mt-0 header-title">Arrears History Report</h4>
                                            <p class="text-muted m-b-30">Select the dates to view the report</p>
                                     <form action="{{route('arrears.report.details')}}" method="POST">
                                         {{ csrf_field() }}

                                         <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Select Dealer:</label>
                                                <div class="col-sm-10">
