...
<title>Pak Indus Ice Factory - General Report</title>
    ...
    <body>
        ...
        <div id="wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">General Report</h4>
                                    <ol class="breadcrumb">
            ...
            @endif   
                                            ...
                                            <h4 class="mt-0 header-title">General Report</h4>
                                            <p class="text-muted m-b-30">Select the dates to view the report</p>
                                     <form action="{{route('general.report.details')}}" method="POST">
                                         {{ csrf_field() }}
