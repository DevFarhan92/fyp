...
<title>Pak Indus Ice Factory- Factory Goods Report Details</title>
    ...
    <body>
        ...
        <div id="wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Factory Goods Report Details</h4>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Factory Goods Report Details</li>
                                    </ol>
            ...
            @endif   
                                            ...
                                            <p class="text-muted m-b-30" style="font-size: 16px; text-align: center;">These are all the factory goods present in between <b>{{$start_date1}} - {{$end_date1}}</p>
                                               ...
                                               <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>New Quantity</th>
                                                    <th>Quantity Added/Subtracted</th>
                                                    <th>Quantity Status</th>
                                                    <th>Date Added/Subtracted</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$fg->good_name}}</td>
                                                    <td>{{$fg->previous_quantity}}</td>
                                                     <td>{{$fg->new_quantity}}</td>
                                                     <td>{{$fg->quantity_added_removed}}</td>
                                                      <td>{{$fg->quantity_status}}</td>
                                                    <td>{{date('d-m-Y', strtotime($fg->date_updated))}}</td>
...
function printDiv() {
    ...
    newWin.document.write("<h3 align='center'>These are all the goods present in between {{$start_date1}} - {{$end_date1}}</h3>");
