...
@endif
 ...
 Factory</a></li>
                                        ...
                                        <li class="breadcrumb-item active">View Dealers</li>
                                    </ol>
            ...
            @endif   
                                            ...
                                            <h4 class="mt-0 header-title">View Expenses</h4>
                                            <p class="text-muted m-b-30">These are all the added expenses.</p>
...
$employee_name = \App\employees::select('employee_name')->where('employee_id','=',$e->expense_discription)->pluck('employee_name')->first();
?>
Salary of {{$employee_name}}
                                                    @else
                                                    {{$e->expense_discription}}
                                                    @endif
                                                    </td>
                                                    <td>Rs {{$e->expense_amount}}</td>
                                                    <td>{{$e->expense_type}}</td>
                                                    <td><a href="{{ asset("attachments/expense/{$e->expense_attachment}") }}"> {{$e->expense_attachment}}</a></td>
